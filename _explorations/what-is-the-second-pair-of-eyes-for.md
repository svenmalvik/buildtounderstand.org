...
In 2009, Kemerer and Paulk measured how review speed changes what reviewers find, across 371 reviews by 153 developers. Reviewers who stayed at or below 200 lines an hour found most of the design defects. Faster reviewers found about half. That is what the quicker reviews earlier in this chapter were buying. In 1976 Fagan recommended going slower for systems code, 130 to 150 lines an hour. Meanwhile one in four PRs written with AI is over 400 lines, against 157 without. And nobody has measured minutes per review, so the only numbers for reviewer time are weekly: about 3.2 hours at Google, about 6.4 hours in open source, both self-reported and both from before AI.
