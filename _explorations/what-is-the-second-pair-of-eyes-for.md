...
In 2009, Kemerer and Paulk measured how review speed changes what reviewers find. Reviewers who went no faster than 200 lines an hour found most of the design defects. Faster reviewers found about half. That is what the quicker reviews earlier in this chapter were buying. In 1976 Fagan recommended going slower for systems code, 130 to 150 lines an hour. Meanwhile one in four PRs written with AI is over 400 lines, against 157 without. Nobody knows how long one review takes since nobody has measured it. We only know how much time people have spent reviewing in a week before Ai. At Google it was about 3.2 hours. In open source about 6.4.
